...
.setColor('#ffffff') 
.setAuthor(`ReisNetwork   Moderasyon Komutları`, client.user.avatarURL())
...
.addField(`__Bilgilendirme__`,`<:a_:1109866752428490974>  \`${prefix}davet\` |  ReisNetwork'yi Sunucunuza Davet Edersiniz\n  \`${prefix}botbilgi\` | Botun İstatistiklerini Gösterir \n   \`${prefix}ayarlar\` | Sunucunuzdaki Açık veya Kapalı Komutları Gösterir`)
